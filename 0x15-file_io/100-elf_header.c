 ...
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
 * Description: mthe magic digits are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: is a  pointer that points to array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_entry: as the address of the ELF entry point.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 *
 * Description: If the file fails to close - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argc: The value of arguments given as input.
 * @argv: An array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
 * Description: If file isnt an ELF File or
